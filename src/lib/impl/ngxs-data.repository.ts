...
export abstract class NgxsDataRepository<T>
  implements ImmutableStateContext<T>, DataRepository<T> {
  ...
  @action()
  public setState(val: T | Immutable<T> | StateOperator<Immutable<T>>): Immutable<T> {
